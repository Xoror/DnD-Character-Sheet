...
export const FilterItem = (props) => {
	return (
		<div className="filter-body">
			{props.name}: 
			{props.hasValue ? (<><input value={props.value} onChange={(event) => props.handleInputChange(event, props.index, props.type)} style={{width:"2em", height:"1.4em"}}></input><span>ft</span></>) : null } 
